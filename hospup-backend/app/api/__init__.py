...
api_router.include_router(videos_router, prefix="/videos", tags=["videos"])  # Keep for legacy support
api_router.include_router(videos_router, prefix="/generated-videos", tags=["generated-videos"])  # Alias for AI-generated videos
